...
def main():
    ...
    xsph_fluid = 0.08           # XSPH for fluid
    xsph_boundary = 0.1         # XSPH for boundaries
    viscosity_boundary = 0.02    # Boundary viscosity
         ...
         "AnimationFields": [
            {
                ...
                "scale": scale_anim,
                "shapeType": 0,
                "expression_x": f"((0.33 - y)*{g}/1000) * (1 + tanh((0.33 - y) * 6))/2",
                "expression_y": f"((0.33 - y)*{g}/1000) * (1 + tanh((0.33 - y) * 6))/2",
                "expression_z": ""
            },
            {
                ...
                "expression_y": f"valuey * 0.9 + (tanh((0.33 - y) * 1) * 0.1)",
                "expression_z": ""
            }
        ]
    }
